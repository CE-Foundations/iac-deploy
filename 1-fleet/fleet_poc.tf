...
module "fleet_poc_cluster_0" {
  ...
  gsa_sds_backup_agent_iam_project       = module.fleet_poc.fleet_project.project_id
  gsa_gateway_connect_agent_iam_project  = module.fleet_poc.fleet_project.project_id
  gsa_source_repo_agent_iam_project      = module.fleet_poc.control_plane_source_project.project_id
